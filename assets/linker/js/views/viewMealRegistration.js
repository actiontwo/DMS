...
//
// Purpose:
//          Declare ViewRegisterMealView
// Class:
//          ViewRegisterMealView
// Functions:
//          initialize; addDetailsInfo; render; btnRegisterMeal;
//          viewMealRegistrationByNameAndDay; 
// Called From:
...
var ViewRegisterMealView = Backbone.View.extend({
	...
	initialize: function() {
		...
		//						list of usernames to the comboBox '#nameToBeSelected'
		// REVISIONS:
	...
	render: function() {
		...
		//            Nothing
		// PURPOSE:
		//            Navigate back to Register Meal View
		//						Triggered when user click the 'Register Meal' tab
		// REVISIONS:
		//            05/23/14 - Son Le - Initial revision
		// -------------------------------------------------------------------
		...
		//            Nothing
		// PURPOSE:
		//            Filter & display the models satisfy Name, dayFrom, dayTo conditions
		// REVISIONS:
		//            05/23/14 - Son Le - Initial revision
		// -------------------------------------------------------------------
